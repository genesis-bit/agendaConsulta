...
@section('conteudo')
    <div class ="table-responsive" > <!-- start conatiner -->
        ...
        <div class="d-flex col-lg-12"> <!-- start d-flex -->
            <div class="col-lg-8"> 
                <button href="" class="btn btn-primary" role="button" data-bs-toggle="modal" data-bs-target="#Medicos"> Adicionar Pacientes </button>
            </div> 
        </div> <!-- end d-flex -->
        <br>
            ...
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content">    
                    <div class="container mt-4">    
                        <h2>Informações dos Pacientes</h2>    
                    </div>    
                    <form action="" method="POST" class="row p-lg-3 gy-2">
                        <div class="col-lg-6">
                            <label for="form-control" class="form-label" >Fotográfia</label>
                            <input type="image" class="form-control" id="data_fim" name="data_fim" placeholder=""  required>
                        </div>    
                        <div class="col-lg-6">                        
                            <label for="form-control" class="form-label" >Nome Completo</label>
                            <input type="text" class="form-control" name="nome" id="nome" placeholder="" required>
                        </div>
                        <div class="col-lg-6">
                            <label for="form-control" class="form-label" >Idade</label>
        ...
        <div class="modal fade" id="editar" tabindex="-1" aria-labelledby="modallabel" aria-hidden="true">  <!-- start modal-editar-qualificações-->
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content">    
                    <div class="container mt-4">    
                        <h2>Editar Informações dos Pacientes</h2>    
                    </div>    
                    <form action="" method="POST" class="row p-lg-3 gy-2">
                        <div class="col-lg-6">
                            <label for="form-control" class="form-label" >Fotográfia</label>
        ...
        </div>   <!-- end modal-qualifica-editar -->
         <!-- Modal apagar -->
                ...
                <div class="modal-content">
                    ...
                    <form action="crud_agencia.php" method="POST">
                        <div class="modal-body">
                            <h4>Tem certeza que deseja excluir Paciente ?</h4>
                            <h3 id="nameAPagar"></h3>
                        </div>
