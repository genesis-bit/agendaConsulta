...
@section('conteudo')
        <div class ="table-responsive" > <!-- start conatiner -->
            ...
            <div class="d-flex col-lg-12"> <!-- start d-flex -->
                <div class="col-lg-8"> 
                      <button href="" class="btn btn-primary" role="button" data-bs-toggle="modal" data-bs-target="#Medicos"> Adicionar Médicos </button>
                </div> 
            </div> <!-- end d-flex -->
            <br>
            ...
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content">            
                    ...
                    <form action="" method="POST" class="row p-lg-3 gy-2">
                        ...
                        <div class="col-lg-6">                
                            <label for="form-control" class="form-label" >Especialidade</label>
                        ...
                        <div class="col-lg-6">
                            <label for="form-control" class="form-label" >Nº Carteira Profissional</label>
                            <input type="number" class="form-control" id="data_início" name="data_início" placeholder="" required> 
                        </div>            
                        <div class="col-lg-6">                  
                            <label for="form-control" class="form-label" >Telefone</label>
        ...
        <div class="modal fade" id="editar" tabindex="-1" aria-labelledby="modallabel" aria-hidden="true">  <!-- start modal-editar-->
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content">            
                    <div class="container mt-4">                    
                        <h2>Editar informações dos médicos</h2>                    
                    </div>            
                    <form action="" method="POST" class="row p-lg-3 gy-2">
                        <div class="col-lg-6">                
                            <label for="form-control" class="form-label" >Nome Completo</label>
                ...
                <div class="modal-content">
                    ...
                    <form action="crud_agencia.php" method="POST">
                        <div class="modal-body">
                            <h4>Tem certeza que deseja excluir o medico ?</h4>
                            <h3 id="nameAPagar"></h3>
                        </div>
