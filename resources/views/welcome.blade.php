        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <a href="{{ route('dashboard') }}" class="h-16 w-auto bg-gray-100 dark:bg-gray-900">
                        <img src="{{Vite::asset('resources/imagen/stethoscope-removebg-preview.png')}}" alt="" width="80px">
                    </a>
                </div>
                  <!-- Logo -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-8 lg:gap-8">
                        <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Sistema de Marcação de Consulta do Centro Medico Ana Paula</h2>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Seja bem vindo ao nosso Sistema, Aqui poupas tempos e não ficas espera até ao atendimento.
                                   <br> Faça a Marcação da tua consulta Clinica!
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <a href=" {{ route('register') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Registar-se</h2>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Para teres acesso ao nosso sistema precisas se registar!    
                                </p>
                            </div>
                        ...
                        <a href="" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>                           
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Serviços do Sistema</h2>
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    <ul>
                                        <li>Fazer Marcação de Consulta</li>
                                        <li>Consultar a Marcação</li>
                                        <li>Anular Marcação</li>
                                    </ul>
                                </p>
                            </div>
